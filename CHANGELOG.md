...
### Fixed
- Keep reported aux states separate from optimistic UI values so unconfirmed switch commands can be retried instead of silently skipped.

## [0.6.1] - 2026-07-05

### Changed
- Release accumulated Home Assistant, tooling, and GitHub Actions dependency updates.
